...
import (
	...
	_ "github.com/LovePelmeni/OnlineStore/OrderCheckout/models"
...
// go:generate mockgen  -destination=OrderCheckout/mocks kafka.go KafkaBackendInterface
type KafkaBackendInterface interface {
	CreateKafkaProducer() (*kafka.Producer, error)
	CreateKafkaConsumer() (*kafka.Consumer, error)
}

// go:generate mockgen -destination=OrderCheckout/mocks kafka.go KafkaProducerInterface
...
// go:generate mockgen -destination=OrderCheckout/mocks kafka.go KafkaConsumerInterface
...
// Represents Kafka Producer interface.
type KafkaProducer struct {
	Topic    string
	Producer *kafka.Producer
}

// Represents Kafka Consumer interface.
...
func (this *KafkaBackend) CreateKafkaProducer() {
// (*kafka.Producer, error)
	...
	// })
	// if error != nil {
	// 	ErrorLogger.Println("FATAL: KAFKA FAILED TO CREATE PRODUCER.")
	// 	panic(error)
	// }
	// return producer, nil
}
...
func (this *KafkaBackend) CreateKafkaConsumer(){
//  (*kafka.Consumer, error) {
	...
	// })
	// if error != nil {
	// 	ErrorLogger.Println("FATAL: KAFKA FAILED TO CREATE CONSUMER.")
	// 	panic(error)
	// }
